...
# name_L = "15_58_03_05_04_2024_VIDEO_LEFT"
# name_R = "16_35_42_26_02_2024_VID_RIGHT" # 15_59_16_01_04_2024_VIDEO_RIGHT
# name_R = "15_58_03_05_04_2024_VIDEO_RIGHT"

# capL=cv2.VideoCapture("dataCalibrated/" + name_L + ".avi")
# capR=cv2.VideoCapture("dataCalibrated/" + name_R + ".avi")


# name_L = "L_left_calibrated"
# name_R = "L_right_calibrated"
# capL=cv2.VideoCapture("dataCalibrated/cortados/" + name_L + ".avi")
# capR=cv2.VideoCapture("dataCalibrated/cortados/" + name_R + ".avi")
...
# Laptop stretch
name = "16_35_42_26_02_2024_VID"

capL=cv2.VideoCapture('./StereoVision DataBase/Laptop/waiter/integradora/' + name + '_LEFT_calibrated.avi')
capR=cv2.VideoCapture('./StereoVision DataBase/Laptop/waiter/integradora/' + name + '_RIGHT_calibrated.avi')
...
while(capR.isOpened() and capL.isOpened()):
    ...
    try:
        ...
        graph_circles(keypointsR_sorted, w, h, frameR)
    ...
    if save_video:
        ...
        # archivo_f_l = open("predictionYolo/predict39/16_35_42_26_02_2024_VID_LEFT_tracking/16_35_42_26_02_2024_VID_LEFT_" + str(frame_num) +  ".txt", "w")
        # archivo_f_r = open("predictionYolo/predict40/16_35_42_26_02_2024_VID_RIGHT_tracking/16_35_42_26_02_2024_VID_RIGHT_" + str(frame_num) +  ".txt", "w")
        """
        ...
        # salida_L = cv2.VideoWriter('predictionYolo/predict39/16_35_42_26_02_2024_VID_LEFT_YOLO_tracking.avi',cv2.VideoWriter_fourcc(*'XVID'),20.0,(int(frameL.shape[1]), int(frameL.shape[0])))
        # salida_R = cv2.VideoWriter('predictionYolo/predict40/16_35_42_26_02_2024_VID_RIGHT_YOLO_tracking.avi',cv2.VideoWriter_fourcc(*'XVID'),20.0,(int(frameR.shape[1]), int(frameR.shape[0])))
        """
